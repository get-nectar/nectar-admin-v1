...
export function useCheckProductImage<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; shopifyResourceId?: string; tiktokProductId?: string; customProductId?: string; url?: string; width?: number; height?: number; altText?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
