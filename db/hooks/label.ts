...
export function useCheckLabel<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; type?: LabelType; workspaceId?: string; title?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
