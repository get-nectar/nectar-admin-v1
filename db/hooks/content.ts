...
import type { Platform, AssignType, ContentType, ContentSurface, ContentSource, ContentAnalysisStatus } from '@prisma/client';

export function useCheckContent<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { isStarred?: boolean; previewMessage?: string; platform?: Platform; isDone?: boolean; isAIGeneratingResponse?: boolean; isAnswered?: boolean; assignType?: AssignType; id?: string; platformContentId?: string; contentType?: ContentType; contentSurface?: ContentSurface; authorId?: string; relevantAccountId?: string; sourceType?: ContentSource; isMention?: boolean; isByOwner?: boolean; isFavorited?: boolean; isRemoved?: boolean; permalink?: string; caption?: string; canReply?: boolean; commentMentionerId?: string; analysisStatus?: ContentAnalysisStatus; location?: string; locationId?: string; workspaceId?: string; isDeleted?: boolean }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
